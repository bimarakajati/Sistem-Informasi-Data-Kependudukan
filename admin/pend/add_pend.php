	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="number" class="form-control" id="rt" name="rt" placeholder="RT" required maxlength="4" oninput="this.value=this.value.slice(0,this.maxLength)">
				</div>
				<div class="col-sm-3">
					<input type="number" class="form-control" id="rw" name="rw" placeholder="RW" required maxlength="4" oninput="this.value=this.value.slice(0,this.maxLength)">
				</div>
			</div>
